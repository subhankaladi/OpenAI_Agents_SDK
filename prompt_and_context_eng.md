...
LLMs are text-based prediction systems that:

1. Receive your text input (prompt)  
2. Predict what word or token should come next  
3. Continue this process to create a complete output  

### Key Idea: Predictive Text Completion
LLMs don’t truly “understand.”  
They predict likely continuations based on your input — like an extremely advanced autocomplete system.
